...
public class DaoEstadoImpl implements DaoEstado<Estado> {
    ...
    public void save(Estado e) {
        try {
            ...
            PreparedStatement pst = connect.prepareStatement("Insert into Estado (id_estado,estado) values(?,?)");
    ...
    public void update(Estado e) {
        ...
        try {
            ...
            PreparedStatement pst = connect.prepareStatement("Update Estado set estado=? where id_estado=?");
