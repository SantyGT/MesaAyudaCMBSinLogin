        ...
        try {
            if (existe(u)) {
                ...
                try {
                    ...
                    PreparedStatement pst = connect.prepareStatement("Insert into User (Iduser,Nombre_usuario,Cedula_usuario,Correo,Clave,Estado_usuario) values(?,?,?,?,?,?)");
    ...
    public List<Usuario> getUsuario() {
        ...
        try {
            ...
            PreparedStatement pst = connect.
                prepareStatement("Select * from User order by 1");
